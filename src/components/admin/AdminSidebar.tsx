...
export default function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
  ...
  const NAV_ITEMS = [
    ...
    { label: t("admin.nav.providers"), href: "/admin/providers", icon: <Icons.HeartHand size={20} />, permission: "stores" },
    { label: "รีวิว", href: "/admin/reviews", icon: <Icons.Smile size={20} />, permission: "support" },
    { label: "แจ้งข่าว", href: "/admin/broadcast", icon: <Icons.Bell size={20} />, permission: "support" },
