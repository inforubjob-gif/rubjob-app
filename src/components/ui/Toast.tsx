...
export default function Toast({ message, type, isVisible, onClose }: ToastProps) {
  ...
  return (
    <div className={`fixed bottom-24 left-1/2 -translate-x-1/2 z-[9999] animate-slide-up flex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl ${config.bg} ${config.text}`}>
