    ...
    <div className="flex flex-col min-h-dvh bg-white relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-[#F3B34E] via-[#F5C16E] to-[#F3B34E] px-6 pt-14 pb-10 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="w-16 h-16 bg-white/20 backdrop-blur-md rounded-3xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-amber-500/20 ring-4 ring-white/30">
            <Icons.Logo size={40} variant="white" />
          </div>
