          ...
          <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
             <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-slate-900/50 border-2 border-slate-800 rounded-3xl p-5 font-black text-sm focus:outline-none focus:border-primary/50 transition-all"
             ...
             <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-slate-900/50 border-2 border-slate-800 rounded-3xl p-5 font-mono text-sm focus:outline-none focus:border-primary/50 transition-all font-bold"
             ...
             <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-slate-900/50 border-2 border-slate-800 rounded-3xl p-5 font-bold text-sm focus:outline-none focus:border-primary/50 transition-all"
                  placeholder="john@example.com"
                />
             </div>
             <div className="pt-4">
               <Button onClick={() => setStep(2)} disabled={!formData.name || !formData.phone} className="w-full bg-primary text-slate-950 py-6 rounded-3xl font-black text-xs uppercase tracking-[0.3em] shadow-2xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
                  Next Step
               </Button>
             </div>
          </div>
          ...
          <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
                ...
                <div className="grid grid-cols-3 gap-4">
                   {['bike', 'car', 'truck'].map(type => (
                      <div 
                        ...
                        className={`p-6 rounded-3xl border-2 transition-all flex flex-col items-center gap-2 cursor-pointer ${formData.vehicleType === type ? 'bg-primary/10 border-primary text-primary' : 'bg-slate-900/50 border-slate-800 text-slate-600'}`}
                      >
             ...
             <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-slate-900/50 border-2 border-slate-800 rounded-3xl p-5 font-black text-sm focus:outline-none focus:border-primary/50 transition-all uppercase"
             ...
             <div className="pt-4 grid grid-cols-2 gap-4">
               <Button onClick={() => setStep(1)} className="w-full bg-slate-900 text-slate-400 py-6 rounded-3xl font-black text-xs uppercase tracking-widest">
                  Back
               </Button>
               <Button onClick={() => setStep(3)} disabled={!formData.licensePlate || !formData.idNumber} className="w-full bg-primary text-slate-950 py-6 rounded-3xl font-black text-xs uppercase tracking-widest shadow-2xl shadow-primary/20">
                  Almost Done
               </Button>
             </div>
          </div>
                ...
                {[
                  ...
                  <div key={doc.id} className="space-y-3">
                     ...
                     <div 
                       ...
                       className={`relative aspect-[16/6] rounded-3xl border-2 border-dashed transition-all cursor-pointer overflow-hidden flex flex-col items-center justify-center ${getDocPreview(doc.id) ? 'border-primary bg-primary/5' : 'border-slate-800 bg-slate-900/50'}`}
                     >
