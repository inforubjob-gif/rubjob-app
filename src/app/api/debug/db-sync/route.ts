...
export async function GET() {
  try {
    ...
    const schemaStatements = [
      ...
      `CREATE TABLE IF NOT EXISTS stores (id TEXT PRIMARY KEY, ownerId TEXT NOT NULL, name TEXT NOT NULL, address TEXT NOT NULL, lat REAL, lng REAL, serviceRadiusKm REAL DEFAULT 5, baseDeliveryFee REAL DEFAULT 0, extraFeePerKm REAL DEFAULT 10, isActive INTEGER DEFAULT 1, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (ownerId) REFERENCES users(id));`,
