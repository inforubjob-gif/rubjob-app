  ...
  return (
    <div className="flex flex-col min-h-dvh bg-slate-50 relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 mt-10">
          ...
          <div className="text-white flex-1 min-w-0">
            ...
            <p className="text-[10px] text-white/70 font-black uppercase tracking-wider mt-1 flex items-center gap-1.5">
              ...
              {t("rider.profile.verifiedHero")} #{riderSession?.id?.slice(-4)}
            </p>
          </div>
        </div>
      </header>
      ...
      <div className="relative z-10 flex-1 px-5 -mt-4 space-y-6 pb-24 animate-fade-in">
          ...
          <Card className="p-4 overflow-hidden border-none shadow-xl">
             <div className="flex items-center justify-between">
               <div className="flex items-center gap-4">
                  ...
                  <div>
                      <p className="text-xs font-black text-slate-400 uppercase leading-none mb-1">{t("rider.profile.workStatus")}</p>
        ...
        {/* Rider Settings Menu */}
        <section>
          <h2 className="text-xs font-black text-slate-900 uppercase mb-3 px-1">{t("rider.profile.settings")}</h2>
          <Card className="divide-y divide-slate-50 overflow-hidden shadow-xl">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-slate-400">{prefs?.serviceArea || t("common.notSet")}</p>
              </div>
              <Icons.Back size={14} className="text-slate-200 rotate-180 group-hover:text-primary transition-colors" />
            </button>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-slate-400">{prefs?.vehicleType || t("common.notSet")}</p>
              </div>
              <Icons.Back size={14} className="text-slate-200 rotate-180 group-hover:text-primary transition-colors" />
            </button>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-bold text-rose-600">{t("rider.profile.logout")}</p>
            <p className="text-[11px] text-rose-300 uppercase font-black">{t("rider.profile.verifiedHero")} #{riderSession?.id?.slice(-4)}</p>
          </div>
        </button>
