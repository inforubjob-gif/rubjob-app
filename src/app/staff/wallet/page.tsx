...
export default function StaffWalletPage() {
  ...
  const balance = 3840.50;

  const transactions = [
    { id: "TRX-102", type: t("staff.wallet.jobCompletion"), amount: 150, date: "Today, 14:02", status: t("staff.wallet.success") },
    { id: "TRX-101", type: t("staff.wallet.jobCompletion"), amount: 480, date: "Today, 10:45", status: t("staff.wallet.success") },
    { id: "WDR-005", type: t("staff.wallet.withdrawal"), amount: -2000, date: "Yesterday", status: t("staff.wallet.pending") },
    { id: "TRX-099", type: t("staff.wallet.jobCompletion"), amount: 120, date: "Yesterday", status: t("staff.wallet.success") },
  ];
      ...
      <header className="bg-primary text-white px-5 pt-12 pb-10 rounded-b-[3rem] shadow-xl relative overflow-hidden text-center">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-baseline justify-center gap-2 mb-8 text-white">
            <span className="text-5xl font-black tracking-tight drop-shadow-md">฿3,840</span>
            <span className="text-lg font-bold opacity-50">.50</span>
          </div>
