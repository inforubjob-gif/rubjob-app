    ...
    <div className="flex flex-col min-h-dvh bg-slate-50 relative overflow-hidden">
      ...
      <header className="relative z-10 px-5 pt-12 pb-6">
        <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-xl font-black text-white tracking-tight drop-shadow-sm">{t("staff.myOrders")}</h1>
        </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-sm font-bold text-slate-800 leading-tight">
                    {t(`orders.services.${order.svc}`) || (order.svc === "home_cleaning" ? t("orders.services.home_cleaning") : t("staff.laundryService"))}
                </h3>
