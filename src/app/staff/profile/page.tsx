  ...
  return (
    <div className="flex flex-col min-h-dvh bg-slate-50">
      ...
      <div className="flex-1 px-5 pt-6 space-y-7 pb-24 animate-fade-in">
        ...
        <Card className="p-5 border-none shadow-sm shadow-primary/5 rounded-[2.5rem] bg-white border border-primary/10">
           <div className="flex items-center justify-between">
             <div className="flex items-center gap-4">
                ...
                <div>
                    <h3 className="text-sm font-black text-slate-900 uppercase tracking-tight">{t("staff.profile.workStatus")}</h3>
                    <p className="text-[10px] text-emerald-500 font-bold uppercase">{workStatus ? t("staff.profile.receivingJobs") : t("staff.profile.notReceiving")}</p>
                </div>
             </div>
             <button 
        ...
        <section>
          <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.25em] mb-4 pl-1">{t("staff.profile.settings")}</p>
          <div className="space-y-3">
             <SettingItem 
                icon={<Icons.Globe size={20} />} 
                label={t("staff.profile.language")} 
        ...
        <section>
          <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.25em] mb-4 pl-1">{t("staff.profile.account")}</p>
          <button 
            onClick={logout}
          ...
          >
             ...
             <span className="text-sm font-black text-red-500 uppercase tracking-tight">{t("staff.profile.logout")}</span>
          </button>
        </section>
       </div>
