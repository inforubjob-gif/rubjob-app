...
export default function Error({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-dvh bg-slate-50 px-6 text-center">
      <div className="w-24 h-24 bg-rose-50 text-rose-500 rounded-[2.5rem] flex items-center justify-center mb-8 shadow-xl shadow-rose-500/10 animate-bounce">
        <Icons.Lock size={48} strokeWidth={2.5} />
      </div>
      
      <h1 className="text-2xl font-black text-slate-900 mb-2 uppercase tracking-tight">Oops! Something went wrong</h1>
      <p className="text-sm text-slate-500 font-bold max-w-[280px] leading-relaxed mb-10">
        เกิดข้อผิดพลาดขึ้นครับ ทีมงานได้รับการแจ้งเตือนแล้ว กรุณาลองใหม่อีกครั้ง
      </p>
