    ...
    <div className="flex flex-col min-h-screen bg-slate-50 pb-24">
      ...
      <div className="bg-gradient-to-b from-primary to-primary-dark px-5 pt-4 pb-10 relative">
        <div className="flex items-center gap-3 mb-4">
          <button onClick={() => router.push("/partner-service/profile")} className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center">
      ...
      <div className="px-5 -mt-6 relative z-10 space-y-4">
          ...
          services.map(svc => (
            <Card key={svc.id} className="p-5 flex flex-col gap-3 relative overflow-hidden group border-2 border-transparent hover:border-primary/20 transition-colors">
              ...
              <div className="flex items-center gap-2 mt-2 pt-3 border-t border-slate-100">
                <Button variant="secondary" size="sm" className="flex-1 text-[11px] py-2" onClick={() => router.push(`/partner-service/services/create?edit=${svc.id}`)}>
                  แก้ไข
                </Button>
                <Button 
                  variant="outline" 
        ...
        <Button 
          ...
          onClick={() => router.push("/partner-service/services/create")}
        >
