    ...
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-b from-primary to-primary-dark px-5 pt-4 pb-14 relative">
        <div className="flex items-center gap-3 mb-6">
          <button onClick={() => router.push("/partner-service")} className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center">
      ...
      <div className="px-5 -mt-6 space-y-4 pb-24 relative z-10">
        ...
        <Card className="p-6">
          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              {gigs.map((gig: any) => {
                ...
                return (
                  <div key={gig.id} onClick={() => router.push("/partner-service/services")} className="flex items-center gap-4 bg-white rounded-xl p-3 border border-slate-100 shadow-sm active:scale-95 transition-all cursor-pointer">
          ...
          <Button 
            ...
            onClick={() => router.push("/partner-service/services")}
          >
