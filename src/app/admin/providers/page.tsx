     ...
     <div className="overflow-x-auto">
      <table className="break-words w-full text-left text-sm ">
       <thead className="bg-slate-50/80 backdrop-blur-sm text-slate-400 font-black uppercase text-[10px] tracking-[0.15em] border-b border-slate-100">
        <tr>
         <th className="px-4 py-5">ข้อมูลโปรไฟล์</th>
         <th className="px-4 py-5">จำนวน Gig</th>
         <th className="px-4 py-5">ลงทะเบียนเมื่อ</th>
         <th className="px-4 py-5">สถานะ</th>
         <th className="px-4 py-5 text-right">จัดการ</th>
        </tr>
       </thead>
       <tbody className="divide-y divide-slate-100">
        {filtered.map(p => (
         <tr key={p.id} className="hover:bg-slate-50/50 transition-all group">
          ...
          <td className="px-4 py-6 text-slate-500 font-medium text-xs">
