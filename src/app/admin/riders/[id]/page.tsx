  ...
  return (
    <div className="max-w-7xl mx-auto py-8">
      <header className="mb-10 flex items-center justify-between">
        <div>
           <h1 className="text-3xl font-black text-slate-900 tracking-tight uppercase">{t('admin.riders.edit.title')}</h1>
           <p className="text-slate-500 font-medium mt-2">{t('admin.riders.edit.subtitle')} <span className="text-slate-900 font-bold">{riderData.name}</span>.</p>
        </div>
