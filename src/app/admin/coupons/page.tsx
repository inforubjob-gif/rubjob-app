     ...
     <div className="overflow-x-auto">
      <table className="break-words w-full text-left text-sm ">
       <thead className="bg-slate-50 text-slate-500 font-bold uppercase text-[10px] tracking-wider border-b border-slate-200">
        <tr>
         <th className="px-4 py-4">{t('admin.coupons.table.promoCode')}</th>
         <th className="px-4 py-4">{t('admin.coupons.table.discount')}</th>
         <th className="px-4 py-4">สิทธิ์</th>
         <th className="px-4 py-4">{t('admin.coupons.table.usage')}</th>
         <th className="px-4 py-4">{t('admin.coupons.table.expiry')}</th>
         <th className="px-4 py-4">{t('admin.coupons.table.status')}</th>
         <th className="px-4 py-4 text-right">{t('admin.coupons.table.actions')}</th>
        </tr>
       </thead>
        ...
        {coupons.map(coupon => {
         ...
         return (
          <tr key={coupon.id} className="hover:bg-slate-50/50 transition-colors group">
           ...
           <td className="px-4 py-4 font-medium text-xs text-slate-500">
