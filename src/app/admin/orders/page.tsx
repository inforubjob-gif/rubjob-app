      ...
      <div className="overflow-x-auto scrollbar-hide">
       <table className="break-words w-full text-left text-sm ">
        <thead className="bg-slate-50/50 text-slate-400 font-black uppercase text-[10px] tracking-[0.15em] border-b border-slate-100">
         <tr>
          <th className="px-4 py-5">{t('admin.orders.table.id')}</th>
          <th className="px-4 py-5">{t('admin.orders.table.status')}</th>
          <th className="px-4 py-5">{t('admin.orders.table.customer')}</th>
          <th className="px-4 py-5">ร้านซัก</th>
          <th className="px-4 py-5">{t('admin.orders.table.photos')}</th>
          <th className="px-4 py-5">{t('admin.orders.table.assignRider')}</th>
          <th className="px-4 py-5">{t('admin.orders.table.action')}</th>
         </tr>
        </thead>
