    ...
    return (
      <div className="flex flex-col h-dvh bg-slate-50">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3 pb-28">
          ...
          {messages.map((m) => {
            const isMe = m.senderType === "store" || m.senderType === "rubber";
            return (
    ...
    <div className="flex flex-col min-h-dvh bg-slate-50">
      ...
      <header className="bg-primary text-white px-5 pt-12 pb-8 rounded-b-[2rem] shadow-xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 mb-4">
          <button
            onClick={() => router.push("/partner-store/profile")}
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-white/80 font-bold mt-1 leading-relaxed">ส่งข้อความถึงแอดมินผ่าน LINE ได้ทันที ระบบจะรู้อัตโนมัติว่าคุณเป็นร้านค้าครับ</p>
            </div>
