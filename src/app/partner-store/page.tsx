        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-black text-slate-900 uppercase tracking-widest flex items-center gap-2">
               ...
               {activeTab === "incoming" ? t("store.incomingFromRubber") : activeTab === "washing" ? t("store.processing") : t("store.readyForRubber")}
            </h2>
                  ...
                  <Card key={order.id} className="p-5 border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-500 group rounded-[2rem] bg-white">
                    ...
                    <div className="flex gap-3 mt-6 pt-5 border-t border-slate-50">
                      <Button 
                        ...
                        onClick={() => router.push(`/partner-store/orders/${order.id}`)}
                      >
                        {t("common.details")}
                      </Button>
                      {activeTab === "incoming" && (
