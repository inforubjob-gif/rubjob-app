    ...
    <div className="flex flex-col min-h-dvh bg-slate-50">
      ...
      <main className="p-5 space-y-6">
        <section>
          ...
          <Card className="p-5 bg-gradient-to-br from-indigo-500 via-primary to-orange-400 text-white relative overflow-hidden shadow-2xl shadow-primary/20">
            <div className="relative z-10">
              ...
              <div className="flex justify-between items-end">
                ...
                <span className="text-sm font-bold">RUBJOB TESTER</span>
              </div>
            </div>
